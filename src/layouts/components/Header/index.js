...
const MENU_ITEMS = [
  {
    ...
    children: {
      ...
      data: [
        ...
        { code: "my", title: "မြန်မာစာ" },
        { code: "km", title: "ភាសាខ្មែរ" },
          ...
          <Menu items={currentUser ? USER_MENU : MENU_ITEMS}>
            {currentUser ? (
              <img
                ...
                src="https://scontent.fsgn5-2.fna.fbcdn.net/v/t1.6435-9/183049939_1352007521850284_6077138888974604560_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=67bsDRqSWJcAX8KXUU3&_nc_ht=scontent.fsgn5-2.fna&oh=00_AT8sAUiBqVl2m4FLIRxOPm1rJxlVE4lIqAo81iIuojpO3Q&oe=62F4A8F0"
                alt="User name"
              />
            ) : (
